...
def validate_hetero_grid_args(args: argparse.Namespace, world_size: int) -> tuple[int, int]:
    ...
    if args.mimo_run_input_projections_on_llm_ranks and args.llm_only:
        raise ValueError("--mimo-run-input-projections-on-llm-ranks cannot be used with --llm-only")
