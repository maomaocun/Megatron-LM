...
class IndexerScoringPlan(Enum):
    ...
    PACKED_CP_SINGLE = "packed_cp_single"
    """One sequence per pack, split across context-parallel ranks in zigzag segments."""

    PACKED_CP_MULTI = "packed_cp_multi"
    """Several sequences per pack; boundaries are handed to the kernel as cu_seqlens."""
    ...
    def is_fused(self) -> bool:
        ...
        return self in (
            ...
            IndexerScoringPlan.PACKED_CP_MULTI,
        )
